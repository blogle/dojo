-- Fixture for User Story 10: Group-level Quick Allocation (insufficient RTA)
-- Creates a Subscriptions group with Netflix and Spotify, last month's spending totaling $40.
-- Current Ready-to-Assign is limited to $25 so the quick action must block.

INSERT INTO accounts (account_id, name, account_type, current_balance_minor, currency, is_active, account_class, account_role)
VALUES ('group_cash', 'Group Checking', 'asset', 2500, 'USD', TRUE, 'cash', 'on_budget')
