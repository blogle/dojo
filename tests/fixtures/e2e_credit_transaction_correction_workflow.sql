...
VALUES
    ('00000000-0000-0000-0000-0000000f1601', '00000000-0000-0000-0000-0000000f1601', 'house_checking', 'opening_balance', CURRENT_DATE, 500000, 'Opening balance', 'cleared', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TIMESTAMP '9999-12-31 00:00:00', TRUE, 'fixture'),
    ('00000000-0000-0000-0000-0000000f1602', '00000000-0000-0000-0000-0000000f1602', 'visa_signature', 'opening_balance', CURRENT_DATE, -100000, 'Opening balance', 'cleared', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TIMESTAMP '9999-12-31 00:00:00', TRUE, 'fixture'),
    ('00000000-0000-0000-0000-0000000f1603', '00000000-0000-0000-0000-0000000f1603', 'mastercard_rewards', 'opening_balance', CURRENT_DATE, -50000, 'Opening balance', 'cleared', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TIMESTAMP '9999-12-31 00:00:00', TRUE, 'fixture')
ON CONFLICT (transaction_version_id) DO NOTHING;

-- Update account balances to reflect opening balances
UPDATE accounts SET current_balance_minor = 500000, updated_at = NOW() WHERE account_id = 'house_checking';
UPDATE accounts SET current_balance_minor = -100000, updated_at = NOW() WHERE account_id = 'visa_signature';
UPDATE accounts SET current_balance_minor = -50000, updated_at = NOW() WHERE account_id = 'mastercard_rewards';
