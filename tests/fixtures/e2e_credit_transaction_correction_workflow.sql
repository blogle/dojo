...
WHERE
    category_id IN ('payment_visa_signature', 'payment_mastercard_rewards')
...
VALUES
(
    '00000000-0000-0000-0000-0000000f1601',
    '00000000-0000-0000-0000-0000000f1601',
    'house_checking',
    'opening_balance',
    DATE '2024-01-15',
...
(
    '00000000-0000-0000-0000-0000000f1602',
    '00000000-0000-0000-0000-0000000f1602',
    'visa_signature',
    'opening_balance',
    DATE '2024-01-15',
...
(
    '00000000-0000-0000-0000-0000000f1603',
    '00000000-0000-0000-0000-0000000f1603',
    'mastercard_rewards',
    'opening_balance',
    DATE '2024-01-15',
...
UPDATE accounts SET current_balance_minor = 500000, updated_at = TIMESTAMP '2024-01-15 12:00:00'
WHERE account_id = 'house_checking';
UPDATE accounts SET current_balance_minor = -100000, updated_at = TIMESTAMP '2024-01-15 12:00:00'
WHERE account_id = 'visa_signature';
UPDATE accounts SET current_balance_minor = -50000, updated_at = TIMESTAMP '2024-01-15 12:00:00'
WHERE account_id = 'mastercard_rewards';
