...
export const accountGroupDefinitions = [
  { id: "cash", title: "Cash & Checking", type: "asset", description: "Everyday banking and liquid cash." },
  { id: "accessible", title: "Accessible Assets", type: "asset", description: "Short-term deposits and cash equivalents." },
  { id: "investment", title: "Investments", type: "asset", description: "Brokerage, retirement, and long-term holdings." },
  { id: "credit", title: "Credit & Borrowing", type: "liability", description: "Credit cards, lines of credit, and short-duration loans." },
  { id: "loan", title: "Loans & Mortgages", type: "liability", description: "Mortgages, auto loans, and other long-term debt." },
  { id: "tangible", title: "Tangibles", type: "asset", description: "Appraised property, vehicles, and collectables." },
];
