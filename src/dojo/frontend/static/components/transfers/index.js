...
const handleTransferSubmit = async (event) => {
  ...
  try {
    ...
    setFormError(errorEl, "");
    await Promise.all([refreshTransactions(), refreshAccountsPage(), refreshBudgetsData()]);
    renderBudgetsPage();
...
export const initTransfers = ({ onTransactionsRefresh, onAccountsRefresh, onBudgetsRefresh, onBudgetsRender } = {}) => {
