...
- [ ] Establish backend scaffolding (module layout, settings, entrypoint) and automated schema bootstrapping.
- [ ] Implement DuckDB schema, migration runner, and transaction entry service with full-temporal writes and invariant tests.
- [ ] Expose net worth API plus SPA wiring, and add regression tests plus docs/changelog updates.
