...
const INSUFFICIENT_FIXTURE = "tests/fixtures/e2e_group_quick_allocate_insufficient.sql";
const SUFFICIENT_FIXTURE = "tests/fixtures/e2e_group_quick_allocate_sufficient.sql";
